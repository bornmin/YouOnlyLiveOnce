...
public:
    ...
    void fireEnumBroadCastMethodEvent(const ::v1::commonapi::HelloWorld::testEnum& outputEnum);
    ...
    : CommonAPI::DBus::DBusStubAdapter(_address, _connection,false),
      HelloWorldDBusStubAdapterHelper(_address, _connection, false, _stub) {
        ...
        HelloWorldDBusStubAdapterHelper::addStubDispatcher({ "structInMethod", "(is)" }, &structInMethodStubDispatcher);
...
protected:
    virtual const char* getMethodsDBusIntrospectionXmlData() const {
        static const std::string introspectionData =
            ...
            "</method>\n"
            "<signal name=\"enumBroadCastMethod\">\n"
            "<arg name=\"outputEnum\" type=\"i\" />\n"
            "</signal>\n"
            ...
            "<arg name=\"_structParameter\" type=\"(is)\" direction=\"in\" />\n"
            "<arg name=\"_output\" type=\"i\" direction=\"out\" />\n"
            "</method>\n"
            "<method name=\"structOutMethod\">\n"
            "<arg name=\"_input\" type=\"i\" direction=\"in\" />\n"
            "<arg name=\"_structParameter\" type=\"(is)\" direction=\"out\" />\n"
            "</method>\n"
            ;
...
CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ...
    &HelloWorldStub::structOutMethod, "(is)",
    std::make_tuple(static_cast< CommonAPI::DBus::IntegerDeployment* >(nullptr)),
    std::make_tuple(static_cast< ::v1::commonapi::HelloWorld_::testStructDeployment_t* >(nullptr)));

template <typename _Stub, typename... _Stubs>
void HelloWorldDBusStubAdapterInternal<_Stub, _Stubs...>::fireEnumBroadCastMethodEvent(const ::v1::commonapi::HelloWorld::testEnum& outputEnum) {
    CommonAPI::DBus::DBusStubSignalHelper<CommonAPI::DBus::DBusSerializableArguments<
    ::v1::commonapi::HelloWorld::testEnum
    >>::sendSignal(
            *this,
            "enumBroadCastMethod",
            "i",
