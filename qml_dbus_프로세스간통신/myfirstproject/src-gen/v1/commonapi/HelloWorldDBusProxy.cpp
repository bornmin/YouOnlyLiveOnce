...
,        enumBroadCastMethod_(*this, "enumBroadCastMethod", "i", std::make_tuple(static_cast< CommonAPI::EmptyDeployment* >(nullptr)))
{
}


HelloWorldDBusProxy::EnumBroadCastMethodEvent& HelloWorldDBusProxy::getEnumBroadCastMethodEvent() {
    return enumBroadCastMethod_;
}
