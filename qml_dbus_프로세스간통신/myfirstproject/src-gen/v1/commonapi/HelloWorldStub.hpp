...
class HelloWorldStubAdapter
 ...
 public:
    ...
    /**
    * Sends a broadcast event for enumBroadCastMethod. Should not be called directly.
    * Instead, the "fire<broadcastName>Event" methods of the stub should be used.
    */
    virtual void fireEnumBroadCastMethodEvent(const ::v1::commonapi::HelloWorld::testEnum &_outputEnum) = 0;
...
public:
    ...
    /// Sends a broadcast event for enumBroadCastMethod.
    virtual void fireEnumBroadCastMethodEvent(const ::v1::commonapi::HelloWorld::testEnum &_outputEnum) {
        auto stubAdapter = CommonAPI::Stub<HelloWorldStubAdapter, HelloWorldStubRemoteEvent>::stubAdapter_.lock();
        if (stubAdapter)
            stubAdapter->fireEnumBroadCastMethodEvent(_outputEnum);
    }
